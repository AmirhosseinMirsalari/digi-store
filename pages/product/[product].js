...
const HomePage = ({
  ...
  const [specificationsDisplayCount, setSpecificationsDisplayCount] =
    useState(5);
  const specificationsLength = product.products_values.data.length;
  ...
  useEffect(() => {
    const rates = product.seller_views.data.map((item) => item.rate);
    ...
    menu.current.childNodes.forEach((item, index) => {
      item.addEventListener(
        ...
        (e) => {
          ...
          setScrolled(index + 1);
          if ([index] + 1 == [index] + 1) {
            activeLine.current.style.left =
              menuArray[index].current.offsetLeft + "px";
            activeLine.current.style.width =
              menuArray[index].current.offsetWidth + "px";
          }
  ...
  useEffect(() => {
    function scrollHandler() {
      ...
      if (
        userScroll &&
        window.screenTop < sectionFirst.current?.getBoundingClientRect().top
      ) {
        activeLine.current.style.left = moarefi.current.offsetLeft + "px";
        activeLine.current.style.width = moarefi.current.offsetWidth + "px";
      }
    ...
    <>
      ...
      <div className="pb-8 lg:pb-0  h-auto -mt-[-10px] lg:mt-0 max-w-screen-3xl mx-auto	">
                    ...
                    return (
                      ...
                      <a> */}
                        <div
                          ...
                          onClick={(e) =>
                            relatedProductLink(relatedProduct.slug)
                          }
        ...
        <div className="w-auto h-auto  bg-white">
          ...
          <nav
            ref={nav}
            className={`hidden mt-6 pt-2 mr-4 ml-[32px] w-auto h-auto border border-t-0 border-r-0 border-l-0 border-[#e0e0e2] bg-white z-[3] sticky text-white xl:block ${
              showSticky ? "top-[107px]" : "top-[59px]"
            } `}
          >
            <ul
              ref={menu}
            ...
            >
              <li
                ...
                className={`py-2 px-4 cursor-pointer ${
                  scrolled == 1 ? "text-[#ef394e]" : "text-[#81858b]"
                }`}
              >
                معرفی
              </li>
              <li
                ref={moshakhasat}
                className={`py-2 px-4 cursor-pointer ${
                  scrolled == 2 ? "text-[#ef394e]" : "text-[#81858b]"
                }`}
              >
                مشخصات
              </li>
              <li
                ref={didgah}
                className={`py-2 px-4 cursor-pointer ${
                  scrolled == 3 ? "text-[#ef394e]" : "text-[#81858b]"
                }`}
              >
                دیدگاه ها
              </li>
              <li
                ref={porsesh}
                className={`py-2 px-4 cursor-pointer ${
                  scrolled == 4 ? "text-[#ef394e]" : "text-[#81858b]"
                }`}
              >
                پرسش ها
              </li>
          ...
          <section className="lg:flex xl:grid grid-cols-12 pb-16">
            ...
            <div className="xl:col-span-9 xl:mx-5 px-4 lg:px-0">
              ...
              <div ref={sectionThird} className="w-full h-auto">
                              ...
                              <div className="flex flex-row mt-6">
                                ...
                                <div className="flex flex-col w-full">
                                  ...
                                  <div className="flex flex-col border-2 border-t-0 border-r-0 border-l-0 border-[#f0f0f1] py-2 w-full">
                                    ...
                                    {comment.positive_comments.data
                                      .map((c) => c.attributes)
                                      .map((positive, index) => {
                                        return (
                                    ...
                                    {comment.negative_comments.data
                                      .map((c) => c.attributes)
                                      .map((negative, index) => {
                                        return (
                                          <div className="flex flex-row items-end py-1">
                ...
                <div
                  className={`w-full top-0 left-0 h-full transition-all duration-500 flex items-center justify-center z-[999] ${
                    openCustomersComment ? "fixed" : "hidden"
                  } `}
                >
                  <div
              ...
              <div ref={sectionFour} className="w-full h-auto">
                    ...
                    <div className="flex flex-row lg:flex-col w-full gap-y-4 gap-x-6 lg:gap-x-0">
                      ...
                      {questions.length > 0 ? (
                        ...
                        <div className="flex justify-center items-center text-center">
                          <p className="text-center">هنوز سوالی ثبت نشده است</p>
                        </div>
                      )}
                ...
                {questions.map((question) => question).length > 0 ? (
                  ...
                  <div className="flex justify-center items-center py-2 lg:hidden">
                    <h2 className="font-bold ">هیچ سوالی موجود نمی باشد</h2>
                  </div>
                )}
                ...
                <div
                  className={`w-full top-0 left-0 h-full transition-all duration-500 flex items-center justify-center z-[999] ${
                    openCustomersQuestion ? "fixed" : "hidden"
                  } `}
                >
                  <div
            ...
            <div className="hidden mt-8 xl:flex xl:col-span-3 mx-8">
              <div
                className={`sticky select-none w-full h-fit  productPriceBg lg:border border-t-[#f0f0f1] my-4 lg:my-0 lg:border-t-8 border-[#e0e0e2] rounded-lg py-5 ${
                  showSticky ? "top-44" : "top-32"
                }`}
              >
                <div className="px-5 flex flex-col pt-5 border border-t-0 border-l-0 border-r-0 border-[#e0e0e2]  pb-2">
                  <h3 className="font-semibold pb-6">فروشنده</h3>
