...
const Footer = () => {
  ...
  return (
    <footer className="bg-white shadow-md flex justify-center border border-l-0 border-r-0 border-b-0 mt-6  px-4 py-4 pb-20 lg:pb-0">
      <div className="max-w-screen-2xl">
        ...
        <div className="flex flex-col lg:flex-row mb-4">
          <div className="w-full lg:w-8/12 flex justify-between  flex-wrap lg:px-6 gap-x-4 mb-5 lg:mb-0">
            <div className="flex flex-col">
              ...
              <Link href="/">
                <a className="text-[#81858b] text-sm mb-2">فروش در دیجی استور</a>
              </Link>
              <Link href="/">
              ...
              <Link href="/">
                <a className="text-[#81858b] text-sm mb-2">
                  گزارش تخلف در دیجی استور
                </a>
              </Link>
              <Link href="/">
                <a className="text-[#81858b] text-sm mb-2">تماس با دیجی استور</a>
              </Link>
              <Link href="/">
                <a className="text-[#81858b] text-sm mb-2">درباره دیجی استور</a>
              </Link>
            </div>
            <div className="flex flex-col">
              <p className="text-[#424750] font-bold text-base mb-2">
        ...
        <div className="w-full h-auto flex flex-col lg:flex-row mt-6 py-8 border border-r-0 border-l-0">
          <div className="w-full lg:w-1/2">
            <p className="text-[#424750] font-bold text-sm mb-2 ">
              فروشگاه اینترنتی دیجی استور، بررسی، انتخاب و خرید آنلاین
            </p>
            <span className="text-xs text-[#81858b] text-justify">
              ...
              که فروشگاه اینترنتی دیجی استور سال‌هاست بر روی آن‌ها کار کرده و
        ...
        <div className="w-full py-6 ">
          ...
          تمامی حقوق برای دیجی استور محفوظ است!
          </p>
        </div>
      </div>
    </footer>
