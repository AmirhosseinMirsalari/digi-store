...
const Navbar = ({ mainCategory, category }) => {
  ...
  // redux
  const totalBasketCartItem = useSelector((item) => item.cart.total);
  const cartBasketItem = useSelector((item) => item.cart.cart);
  ...
  const mainCategoryName = mainCategory.map(
  ...
  const cartBasketLength = cartBasketItem?.map((item) => item).length;
  ...
  const itemsPrice = cartBasketItem
  ...
  return (
    <div className="xl:border xl:border-t-0 xl:border-l-0 xl:border-r-0 mt-0 !h-auto w-full mb-0 xl:mb-[107px] z-50">
      ...
      >
        ...
        <Link href="/admin">
          <a className="flex items-center mr-2 xl:mr-0 xl:gap-x-1 xl:border xl:bg-[#f0f0f1] xl:px-3 xl:rounded-lg font-bold xl:py-1">
        ...
        >
          ...
          <div className=" absolute  w-4 h-4 rounded-md -bottom-0 -right-0 bg-[#ef394e] text-white flex justify-center items-center text-[10px] cursor-pointer">
            {totalBasketCartItem}
          </div>
          ...
          {showBasketItem &&
            (cartBasketLength > 0 ? (
              <div className="absolute top-[39px] z-50 left-0 py-3 px-2 bg-white h-auto rounded-lg shadow-[0_1px_5px_1px_rgb(0,0,0,0.2),0_1px_5px_-2px_rgb(0,0,0,0.2)] w-max max-w-[350px] ">
                {/* total item */}
                <div className="flex justify-between items-center ">
                  ...
                  <Link href="/checkout/cart">
                    <a className="text-[#19bfd3] text-xs font-bold ml-4">
                      مشاهده ی سبد خرید
                    </a>
                  </Link>
                </div>
                ...
                {/* total item */}
                <div className="px-2 scrollCustomer min-h-0 h-auto max-h-96 overflow-hidden overflow-y-scroll border border-x-0 my-2">
                  {cartBasketItem &&
                    cartBasketItem.map((product) => (
                      <>
                        <div className="grid grid-cols-[118px_minmax(auto,_1fr)] border border-t-0 border-x-0 last:border-0 py-4 !max-w-max">
                          {/* product image */}
                ...
                <div className="flex justify-between items-center py-1">
                  ...
                  <Link href="/checkout/cart" passHref>
                    <button className="bg-[#ef394e] w-auto text-xs text-center text-white !px-6 py-3 rounded-lg font-bold h-fit  lg:px-0">
                      ثبت سفارش
                    </button>
                  </Link>
                </div>
              ...
              <div className="absolute top-[39px] z-50 left-0 py-3 px-2 bg-white h-auto rounded-lg shadow-[0_1px_5px_1px_rgb(0,0,0,0.2),0_1px_5px_-2px_rgb(0,0,0,0.2)] w-[350px] ">
                {/* total item */}
        ...
        <div className="block lg:hidden relative mr-3">
          <Link href="/checkout/cart">
            <a>
              ...
              <div className="absolute  w-4 h-4 rounded-md -bottom-1 -right-0 bg-[#ef394e] text-white flex justify-center items-center text-[10px]">
                {totalBasketCartItem}
              </div>
            </a>
          </Link>
